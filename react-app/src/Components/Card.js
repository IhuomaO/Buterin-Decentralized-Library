...
const Card = ({ metacid, ...props }) => {
  console.log(metacid);
  return (
    <div className=" max-w-[400px] font-inconsolat px-10 py-5 overeflow-wrap min-h-[200px] border shadow-md rounded-md flex flex-col justify-evenly text-white bg-red-700 items-center break-words " {...props}>
